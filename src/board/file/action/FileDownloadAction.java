...
public class FileDownloadAction implements CommandAction {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws Throwable {
        ...
        try {
            ...
            // 한글 인코딩
            String encoding = new String(file_name.getBytes("utf-8"),"iso-8859-1");
            ...
            if (file.isFile()) // 파일이 있을경우
            {
                ...
                fdao.updateFileCount(Integer.parseInt(request.getParameter("board_num")));
            }
